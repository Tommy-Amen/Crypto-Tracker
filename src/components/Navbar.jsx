    ...
    <nav className="flex flex-wrap md:flex-nowrap items-center justify-between gap-4 px-[5%] md:px-[8%] lg:px-[10%] py-5 bg-gray-900/80 backdrop-blur-md border-b border-gray-700/30 sticky top-0 z-50">
      ...
      >
        <div className="relative group">
          ...
          <div className="relative flex items-center">
            <input
              ...
              required
              className="w-full px-6 py-3 border border-gray-600/30 rounded-full focus:outline-none focus:ring-2 focus:ring-emerald-500/50 placeholder-gray-400 text-gray-200 backdrop-blur-sm"
            />
            <button
              type="submit"
              className="z-10 relative right-2 top-1/2 -translate-y-1/2 bg-gradient-to-r from-emerald-600 to-cyan-600 px-4 py-1.5 text-white rounded-full hover:scale-105 transition-all"
            >
        ...
        {filteredCoins.length > 0 && (
          <ul className="absolute w-full bg-gray-800/85 border border-gray-700 mt-2 rounded-lg shadow-xl z-10 backdrop-blur-md">
